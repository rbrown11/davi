...
path = input("what is the path to the folder containing davi output? \n")
...
original_path = input("what is the path to the original detections? \n")

data = pd.read_hdf(original_path)

video_path = input("Finally, what is the path to the video? \n")
...
final1.to_hdf('full_pipeline.h5', key="changed_names", format="fixed")
